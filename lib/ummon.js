 ...
 * @return {Array} All collection names
 */
Ummon.prototype.getTaskIds = function(selector = null){
  var self = this;

  var taskids = Object.keys(self.tasks);

  switch (selector) {
    // null means this function was called without args, to get all task IDs
    case null:
    case '*':
      return taskids;
    // false means the function was called with a selector that isn't a valid task
    case false:
      return [];
