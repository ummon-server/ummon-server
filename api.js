...
module.exports = function(ummon){
  ...
  api.enableCollection = function(req, res, next) {
    ...
    res.json(200, { "message":  "Collection successfully enabled", "tasksEnabled": tasksEnabled} );
    next();
  }
  ...
  api.disableCollection = function(req, res, next) {
    ...
    res.json(200, { "message":  "Collection successfully enabled", "tasksDisabled": tasksDisabled} );
    next();
  }
